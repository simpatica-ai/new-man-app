...
-- Create view to join profiles with auth.users for email access
-- This is needed by get_organization_activity_overview function
CREATE OR REPLACE VIEW public.profile_with_email 
...
GRANT SELECT ON public.profile_with_email TO authenticated;
