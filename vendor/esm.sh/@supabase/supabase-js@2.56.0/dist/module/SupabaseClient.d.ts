...
import { PostgrestClient, PostgrestFilterBuilder, PostgrestQueryBuilder } from 'https://esm.sh/@supabase/postgrest-js@1.21.3/dist/cjs/index.d.ts';
import { RealtimeChannel, RealtimeChannelOptions, RealtimeClient } from 'https://esm.sh/@supabase/realtime-js@2.15.1/dist/module/index.d.ts';
import { StorageClient as SupabaseStorageClient } from 'https://esm.sh/@supabase/storage-js@2.11.0/dist/module/index.d.ts';
