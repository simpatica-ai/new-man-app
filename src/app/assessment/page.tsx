                        ...
                        {!results ? (
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="text-center mb-6">
                                    <h2 className="text-2xl font-semibold text-stone-800 mb-3">Virtue Growth Plan</h2>
                                    <p className="text-stone-600 max-w-4xl mx-auto">
                                        This report has been generated by pairing defects to the associated virtue, and applying understanding of the virtue presenting development recommendation for each virtue. The analysis is augmented by AI interpretation.
                                    </p>
                                </div>
                                ...
                                {/* Top Row with AI Summary and Rose Chart - 50/50 Split */}
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 summary-chart-row">
                                    {/* AI Summary - 50% width */}
                                ...
                                <Card className="border-amber-200 bg-gradient-to-r from-amber-50 to-orange-50 shadow-md">
                                    <CardContent className="p-6">
                                        <div className="text-center mb-4">
                                            <h3 className="text-lg font-semibold text-stone-800 mb-2">Take Your Next Step on Virtue Journey</h3>
                                            <p className="text-sm text-stone-600">Choose to update your answers on the character inventory, download your assessment report to share, or take the next step by going to your Virtue Desktop where the next phase of virtue growth begins</p>
                                        </div>
                                        <div className="flex flex-col sm:flex-row gap-4">
                                            ...
                                            <Link href="/" className="flex-1">
                                                <Button 
                                                    size="lg"
                                                    className="w-full h-12 bg-amber-600 hover:bg-amber-700 text-white transition-all duration-200"
                                                >
                                                    Go to the Virtue Dashboard
                                                </Button>
                                            </Link>
                                        </div>
                                    </CardContent>
